...
def card_average(hand):
    ...
    hand_value = 0
    for item in hand:
        hand_value = hand_value + item
    
    if hand_value == 0:
        return 0
    else:
        return hand_value/(len(hand))
...
def approx_average_is_average(hand):
    ...
    first_and_last_avg = card_average(first_and_last)
    middle_card_index = len(hand)//2
    middle_card = hand[middle_card_index]

    return (first_and_last_avg==card_average_value or middle_card == card_average_value)
